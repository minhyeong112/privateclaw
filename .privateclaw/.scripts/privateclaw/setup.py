...
def main():
    ...
    print("   cd .privateclaw/.scripts && uv run pc-container start")
    print("")
    print("3. Open the dashboard (first time only):")
    print("   uv run pc-container url")
    ...
    print("   c. Run: uv run pc-container telegram <your_bot_token>")
    print("   d. Message your bot on Telegram")
    print("   e. Run: uv run pc-container approve <pairing_code>")
    print("")
